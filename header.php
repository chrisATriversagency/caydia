<header class="header">
    <div class="top-header">
        <div class="site-selector">
            <img src="assets/images/smallcc.svg" alt="Charles and Colvard"> |
            <img src="assets/images/small-caydia.svg" alt="Caydia">
        </div>
        <div class="">
            <a href="#">Three Exclusice Offers</a> just for you.
        </div>
        ...
        <nav class="main-header__left">
            <ul class="main-nav">
                <li class="main-nav__item">
                    <a class="main-nav__link" href="#">Rings</a>
                </li>
                <li class="main-nav__item">
                    <a class="main-nav__link" href="#">Earrings</a>
                </li>
                <li class="main-nav__item">
                    <a class="main-nav__link" href="#">Necklaces</a>
                </li>
                <li class="main-nav__item">
                    <a class="main-nav__link" href="#">Bracelets</a>
                </li>
                <li class="main-nav__item">
                    <a class="main-nav__link" href="#">Looks</a>
                </li>
                <li class="main-nav__item">
                    <a class="main-nav__link" href="#">Our Difference</a>
                </li>
            </ul>
        </nav>
